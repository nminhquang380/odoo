...
//                    bỏ separator + $.param(params) để video slink có thể chạy
                    slideData.embedUrl = slideData.embedCode ? scheme + slideData.embedCode : "";
                ...
                slideData._autoSetDone = _.contains(['infographic', 'presentation', 'document', 'video', 'webpage'], slideData.type) && !slideData.hasQuestion;
            });
